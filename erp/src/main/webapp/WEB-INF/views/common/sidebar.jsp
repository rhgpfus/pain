    ...
    <div class="container-fluid text-center" >
        <div class="col-sm-3 col-md-1 sidebar" id="sideHuman">
          <ul class="nav nav-sidebar">
            <a href="http://erpgo.co.kr/erp/hrm/list">인사 리스트</a></li>
            
          </ul>
          
          <ul class="nav nav-sidebar">                
            <a href="http://erpgo.co.kr/erp/hrm/insert">인사 등록</a></li>
          </ul>
        ...
        <div class="col-sm-3 col-md-1 sidebar" id="sideItem" style="display:none">
          ...
          <ul class="nav nav-sidebar">
            <a href="http://erpgo.co.kr/erp/item/list">품목 리스트</a></li>
          </ul>
          
          <ul class="nav nav-sidebar">                
            <a href="http://erpgo.co.kr/erp/client/clist">거래처 등록</a></li>
          </ul>
          
          <ul class="nav nav-sidebar">
            <a href="http://erpgo.co.kr/erp/purchase/pmlist">구매 조회</a></li>
          </ul>
