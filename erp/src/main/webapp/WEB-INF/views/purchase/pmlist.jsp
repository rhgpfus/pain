...
<script>
	...
	$(document).ready(
			function() {
				var aul = new AjaxUtilUpdateList("purchase/pmlist", "pmup",
						"purchaseNo");
				aul.send();
			})
	//돋보기 클릭시 먹히는 이벤트
						...
						<table id="table" data-height="460"
							...
							<tr>
								...
								<td class="col-md-1"><input type="text" id="clientNo"
									name="iud2" class="postcodify_extra_info" disabled /></td>
								...
								<td class="col-md-1" style="vertical-align: middle">
									<div id="outTd1" data-tableName="purchaseTable"
										...
										<input class="form-control form-min3" type="text"
											id="purchaseNo" name="purchaseNo" data-url="purchase/search"
											size="10"
										...
										<input class="form-control form-min" type="text"
											id="clientName" size="10" disabled />
									</div> <!-- 모달 팝업 -->
							...
							<tr>
								...
								<td><input type="text" id="warehouseName" name="iud6"
									class="postcodify_extra_info" data-req="입고창고를 입력해주세요" /></td>

								<td class="listTh col-md-1" align="center"
									style="vertical-align: middle" bgcolor="cccccc">입고창고</td>
								<td class="col-md-1" style="vertical-align: middle">
									<div id="outTd2" data-tableName="warehouseTable"
										...
										<!-- 거래처이름이름 나오는곳 -->
										<input class="form-control form-min" type="text"
											id="warehouseName" size="10" disabled />
									</div> <!-- 모달 팝업 -->
